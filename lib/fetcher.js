...
Fetcher.prototype._parseDocumentElements = function _parseDocumentElements(elements, done) {
  ...
  elements = elements.filter(function(el) { return el.attribs.class && ! el.attribs.class.match(/bjelke/) && ! el.attribs.class.match(/Indholdsfortegnelse/); } );
  ...
  elements.forEach(function parseSingleElement(el) {
    ...
    // Footnote
       ...
       */
       ...
       result.footnotes.push( text.trim() );
