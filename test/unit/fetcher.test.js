...
describe('Fetcher', function() {
  ...
  describe('Internals', function() {
    ...
    describe('_fetchBodyBox', function() {
      ...
      it('can fetch body and side box from example R0300 page', function(done) {
        requestStub.get.withArgs('https://www.retsinformation.dk/Forms/R0300.aspx', {}).yields(null, null, fs.readFileSync('test/html-examples/R0300.html'));
      ...
      it('returns error when retrieving an invalid HTML document', function(done) {
        requestStub.get.withArgs('https://www.retsinformation.dk/Forms/whatever', {}).yields(null, null, fs.readFileSync('test/html-examples/ft.dk.html'));
  ...
  describe('getMinistryInfo', function() {
    ...
    it('can get ministry info (R0310, Miljøministeriet)', function(done) {
      requestStub.get.withArgs('https://www.retsinformation.dk/Forms/R0310.aspx', {qs:{res: 12}}).yields(null, null, fs.readFileSync('test/html-examples/R0310-12.html'));
   ...
   */
  describe('listMinistryDocuments', function() {

    it('can list ministry documents (R0310, Miljøministeriet, Love/Lovbekendtgørelser)', function(done) {
      requestStub.get.withArgs('https://www.retsinformation.dk/Forms/R0310.aspx', {qs: {res: 12, nres: 1, page: 1}}).yields(null, null, fs.readFileSync('test/html-examples/R0310-12-1.html'));
    ...
    it('can request and parse multiple pages of documents(R0310, Skatteministeriet, Cirkulærer, m.v.)', function(done) {
      requestStub.get.withArgs('https://www.retsinformation.dk/Forms/R0310.aspx', {qs: {res: 14, nres: 3, page: 1}}).yields(null, null, fs.readFileSync('test/html-examples/R0310-14-3-1.html'));
      requestStub.get.withArgs('https://www.retsinformation.dk/Forms/R0310.aspx', {qs: {res: 14, nres: 3, page: 2}}).yields(null, null, fs.readFileSync('test/html-examples/R0310-14-3-2.html'));
      requestStub.get.withArgs('https://www.retsinformation.dk/Forms/R0310.aspx', {qs: {res: 14, nres: 3, page: 3}}).yields(null, null, fs.readFileSync('test/html-examples/R0310-14-3-3.html'));

      fetcher.listMinistryDocuments(14, 3, function(err, documents) {
        if (err) {
          return done(err);
        }

        documents.length.should.equal(139);
  ...
  describe('getDocument', function() {
    it('can parse a document (164746, Bekendtgørelse af lov om forældelse af fordringer, Justitsministeriet)', function(done) {
      requestStub.get.withArgs('https://www.retsinformation.dk/Forms/R0710.aspx', {qs: {id: 164746}}).yields(null, null, fs.readFileSync('test/html-examples/R0710-164746.html'));
